...
/***********************************************************************
 * $Id: alaTypes.h 67200 2014-10-23 08:11:14Z sonumb $
 **********************************************************************/
...
#ifdef _WINDOWS_
#include <windows.h>
typedef CHAR                SChar;      /* Signed   Char       8-bits */
typedef UCHAR               UChar;      /* Unsigned Char       8-bits */
typedef SHORT               SShort;     /* Signed   Small Int 16-bits */
typedef USHORT              UShort;     /* Unsigned Small Int 16-bits */
typedef INT                 SInt;       /* Signed   Integer   32-bits */
typedef UINT                UInt;       /* Unsigned Integer   32-bits */
typedef LONGLONG            SLong;      /* Signed   Big Int   64-bits */
typedef ULONGLONG           ULong;      /* Unsigned Big Int   64-bits */
#else
