...
// interface (eg. Windows, stdout or other GUI).
	...
	typedef short _callback_pref (_callback SHOULD_STOP_ROUTINE)( void );
	typedef short _callback_pref (_callback_local SHOULD_STOP_LOCAL_ROUTINE)( void );
    }
    ...
    typedef _callback short	    (SHOULD_STOP_ROUTINE)( void );
    typedef _callback_local short   (SHOULD_STOP_LOCAL_ROUTINE)( void );
#else
    typedef short _callback_pref (_callback MSG_ROUTINE)( const char * str );
    ...
    typedef short _callback_pref (_callback SHOULD_STOP_ROUTINE)( void );
    typedef short		 (_callback_local SHOULD_STOP_LOCAL_ROUTINE)( void );
#endif
...
typedef SHOULD_STOP_ROUTINE *	    SHOULD_STOP_CALLBACK;    
