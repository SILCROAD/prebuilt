...
#define UL_FILENAME_PROPERTY			1913	    // Used in the UL ODBC driver
#define SA_SQL_ATTR_FAILALL_AUTOPARAM		1914	    //internal only
...
#define SQL_OLEDB_GET_DELPHI_SETTING		10103
