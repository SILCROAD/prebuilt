...
FUNC_INFO( extern, void, _esqlentry_, dbpp_prepare_describe_16, (SQLCA *,char *,char *,short int *,char *,struct sqlda *,struct sqlda *,unsigned int, unsigned short int, a_sql_uint32 ))
FUNC_INFO( extern, void, _esqlentry_, dbpp_prepare_describe_exec_16, (SQLCA *,char *,char *,short int *,char *,struct sqlda *,struct sqlda *,unsigned int, unsigned short int, a_sql_uint32 ))
...
FUNC_INFO( extern, unsigned short, _esqlentry_, db_verify_version_17, ( void ))
