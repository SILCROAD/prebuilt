...
#else
    #define DT_W2STRING	DT_W2STRING_NOT_IMPLEMENTED_FOR_SQLA
    #define DT_W2FIXCHAR DT_W2FIXCHAR_NOT_IMPLEMENTED_FOR_SQLA
    #define DT_STREAMED_BLOB DT_STREAMED_BLOB_NOT_IMPLEMENTED_FOR_SQLA
    #define DT_DEFAULT	DT_DEFAULT_NOT_IMPLEMENTED_FOR_SQLA
#endif
#if defined( UNICODE )
...
#define DT_EXTFN_TABLE  1000
#define DT_ROWTYPE  1001
#define DT_VARRAY  1002
