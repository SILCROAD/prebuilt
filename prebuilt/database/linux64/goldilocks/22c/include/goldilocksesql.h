...
{
    char   *  sqlcname;             /* SQL cursor name */
    void   *  sqlcv;                /* SQL cursor variable */
...
typedef struct sqlargs_t
{
    ...
    int            cumulative;           /* --cumulative option used */
...
int  DBESQL_PositionedCursorDML( void       * aSqlContext,
                                 sqlargs_t  * aSqlArgs );
int  DBESQL_AllocateCursorVariable( void      * aSqlContext,
                                    sqlargs_t * aSqlArgs );
int  DBESQL_FreeCursorVariable( void      * aSqlContext,
                                sqlargs_t * aSqlArgs );
