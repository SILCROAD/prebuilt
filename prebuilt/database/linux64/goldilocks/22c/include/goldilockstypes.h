...
typedef WLONG_VARIABLE_LENGTH_STRUCT SQL_WLONG_VARIABLE_LENGTH_STRUCT;
...
#define SQL_C_REFCURSOR                    SQL_REFCURSOR
...
#define SQL_ATTR_DOT_NET_FOR_ODBC               SQL_DRIVER_CONN_ATTR_BASE + 17
